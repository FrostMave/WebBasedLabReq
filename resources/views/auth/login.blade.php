            ...
            <div class="auth-form-wrapper px-4 py-5">
              ...
              <form class="forms-sample" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="Email" autocomplete="email" autofocus>
                  @error('email')
                ...
                <a href="{{ url('/register') }}" class="d-block mt-3 text-muted">Tidak punya akun? Silahkan daftar disini.</a>
              </form>
            </div>
          </div>
        </div>
