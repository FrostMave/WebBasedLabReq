@extends('layouts.master', ['title' => 'Semua Pengajuan Analisa'])
...
@section('content')
<div>
  <h4 class="mb-3 mb-md-2">Semua Pengajuan Analisa</h4>
</div>
...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Semua Pengajuan Analisa</h6>
          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <b class="@if($sample->stat != 'ditolak') text-success @else text-danger @endif"> {{ $sample->stat }}</b>
                </td>
